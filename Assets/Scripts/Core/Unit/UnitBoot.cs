...
namespace Playstel
{
    public class UnitBoot : MonoBehaviourPun
    {
        [Header("Refs")]
        ...
        public void SetUnitNickName()
        {
            SetUnitNickName(photonView.Owner.NickName);
        }
        ...
        {
            _unit.Move.SetMoveValues(RunSpeed, SprintSpeed);
            _unit.Move.CanMove(true);
        }
